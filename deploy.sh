...
azcopy copy "$HOME/dev/cognitive-demo/config.mjs" "https://bcmisc.blob.core.windows.net/\$web?$SAS" --recursive --overwrite --no-guess-mime-type --content-type "application/javascript"
